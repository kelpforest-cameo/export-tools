<?php
  ...
  // run query	
	$sql = "
select nodes.working_name, nodes.itis_id, functional_groups.name
from nodes inner join functional_groups
on nodes.functional_group_id = functional_groups.id;
";
