<?php
  ...
  // run query	
	$sql = "
select working_name, prod_biomass_ratio
from nodes inner join stages
on nodes.id = stages.node_id
inner join stage_prod_biomass_ratio
on stages.id = stage_prod_biomass_ratio.stage_id;
