<?php
  ...
  // run query	
	$sql = "
SELECT  nodes1.working_name AS node_1_working_name, nodes2.working_name AS node_2_working_name, 'trophic' AS type
...
SELECT  nodes1.working_name AS node_1_working_name, nodes2.working_name AS node_2_working_name, 'facilitation' AS type
...
SELECT  nodes1.working_name AS node_1_working_name, nodes2.working_name AS node_2_working_name, 'competition' AS type
...
SELECT  nodes1.working_name AS node_1_working_name, nodes2.working_name AS node_2_working_name, 'parasitic' AS type
